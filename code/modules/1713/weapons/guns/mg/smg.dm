...
/obj/item/weapon/gun/projectile/submachinegun/spas
	...
	firemodes = list(
		list(name = "semi auto",    burst=1, burst_delay=0.7, recoil=0, move_delay=1, dispersion = list(0.2, 0.4, 0.4, 0.5, 0.6)),
...
/obj/item/weapon/gun/projectile/submachinegun/tec9
	...
	slot_flags = SLOT_SHOULDER | SLOT_BELT
	firemodes = list(
		list(name = "semi auto",	burst=1, burst_delay=0.2, move_delay=1, dispersion = list(0.6, 0.6, 0.7, 0.8, 0.9)),
...
/obj/item/weapon/gun/projectile/submachinegun/ak47
	...
	slot_flags = SLOT_SHOULDER
	firemodes = list(
		list(name = "semi auto",	burst=0.6, burst_delay=0.2, recoil=0, move_delay=1, dispersion = list(0.1, 0.2, 0.1, 0, 0.1)),
...
/obj/item/weapon/gun/projectile/submachinegun/ak74
	...
	stat = "rifle"
	firemodes = list(
		list(name = "semi auto",	burst=0.5, burst_delay=0.1, recoil=0, move_delay=1, dispersion = list(0.1, 0, 0.2, 0, 0.1)),
		list(name = "full auto",	burst=1, burst_delay=1.2, recoil=0, move_delay=4, dispersion = list(1.1, 1.2, 1.3, 1.3, 1.5)),
		)
...
/obj/item/weapon/gun/projectile/submachinegun/ak74m
	...
	slot_flags = SLOT_SHOULDER
	firemodes = list(
		list(name = "semi auto",	burst=0.2, burst_delay=0.7, recoil=0, move_delay=2, dispersion = list(0.1, 0.2, 0.15, 0.2, 0.1)),
