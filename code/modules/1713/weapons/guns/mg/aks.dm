/obj/item/weapon/gun/projectile/submachinegun/ak101
	...
	equiptimer = 15
	firemodes = list(
		list(name = "semi auto",	burst=1, burst_delay=0.7, recoil=0, move_delay=1, dispersion = list(0.1, 0.2, 0, 0.1, 0.2)),
		list(name = "full auto",	burst=1, burst_delay=1.2, recoil=0, move_delay=3, dispersion = list(1.1, 1.2, 1.2, 1.3, 1.4)),
		)
	sel_mode = 1
