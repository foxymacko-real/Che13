										...
										if (istype(src,/obj/structure/cannon/mortar))
											if (locate(/obj/structure/vehicleparts/frame) in target)
												for (var/obj/structure/vehicleparts/frame/F in range(1,target))
													...
													F.w_front[5] -= rand(7,14)
													F.w_back[5] -= rand(7,14)
													F.w_left[5] -= rand(7,14)
													F.w_right[5] -= rand(7,14)
											...
											explosion(target, 2, 3, 4, 6) //ITS FUCKING 160MM ARTILLERY GET DOWN!!
											if (locate(/obj/structure/vehicleparts/frame) in target)
												for (var/obj/structure/vehicleparts/frame/F in range(1,target))
													for (var/mob/M in F.axis.transporting)
														shake_camera(M, 7, 7)
													...
													F.w_front[7] -= rand(10,20)
													F.w_back[7] -= rand(10,20)
													F.w_left[7] -= rand(10,20)
													F.w_right[7] -= rand(10,19)
