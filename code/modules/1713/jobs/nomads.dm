...
//ffa
/datum/job/civilian/civnomadffa
	title = "Nomad"
	rank_abbreviation = ""
	can_be_female = TRUE
	spawn_location = "JoinLateCiv"
...
/datum/job/civilian/civnomadffa/equip(var/mob/living/human/H)
	if (!H)	return FALSE
	H.make_nomad()
	H.equip_to_slot_or_del(new /obj/item/clothing/under/civ2(H), slot_w_uniform)
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
	H.equip_to_slot_or_del(new /obj/item/stack/money/rubles/fivehun(H), slot_r_store)
	H.equip_to_slot_or_del(new /obj/item/stack/money/rubles/onehun(H), slot_l_store)
//	H.give_languages()

	H.add_note("Role", "You are a <b>Nomad</b>. Try to survive! remember you can not kill!")
